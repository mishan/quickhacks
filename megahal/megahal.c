 ...
 */
EXPORT void megahal_setnoprompt(void)
{
    noprompt = TRUE;
}

EXPORT void megahal_setnowrap (void)
{
    nowrap = TRUE;
}
EXPORT void megahal_setnobanner (void)
{
    nobanner = TRUE;
}
...
EXPORT void megahal_setdirectory (char *dir)
{
    directory = dir;
}
...
EXPORT void megahal_initialize(void)
{
    errorfp = stderr;
    statusfp = stdout;
...
EXPORT char *megahal_do_reply(char *input, int log)
{
    char *output = NULL;
...
EXPORT void megahal_learn_no_reply(char *input, int log)
{
    if (log != 0)
	write_input(input);  /* log input if so desired */
...
EXPORT void megahal_cleanup(void)
{
    save_model("megahal.brn", model);
